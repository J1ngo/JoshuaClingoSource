...
(function (root, factory) {
    ...
    WaypointService.prototype.getHandlerSync = function getHandlerSync(scope, callback) {
        ...
        return function (direction) {
            ...
            if (waypoint) {
                ...
                timeout(callback.bind(null, waypoint));
    ...
    /**
     * Sets all waypoints in the collection to false, and sets the indicated waypoint to true.
     *
    ...
    var setWaypoint = function setWaypoint(collection, waypoint) {
        //Removed dependency on JQuery
        angular.forEach(collection, function clearWaypoints(waypoint, index) {
    ...
    var zumWaypoint = function zumWaypoint(WaypointService) {
        return {
            ...
            link: function zumWaypointLink(scope, element, attrs, ctrl) {
                //Removed dependency on JQuery
                var callback = ctrl.processWaypoint.bind(ctrl);
...
controllers.controller("contactCtrl", ["$rootScope", "$scope", "$anchorScroll", function ($rootScope, $scope, $anchorScroll) {

    $scope.mapCenter = "40.3071295, -111.7008516";
...
controllers.controller("softwareCtrl", ["$rootScope", "$scope", "$http", '$log', "$routeParams", "$anchorScroll", function ($rootScope, $scope, $http, $log, $routeParams, $anchorScroll) {
    $scope.projects = [];
    ...
    //load projects
    $http.get('./json/software/projects.json')
       .success(function (data) {
           $scope.projects = data;
           initialize();
       })
...
controllers.controller("welcomeCtrl", ["$rootScope", "$scope", "$anchorScroll", function ($rootScope, $scope, $anchorScroll) {
